...
const char *strtoken(int token) {
  switch (token) {
    ...
    case TOK_OP:		        return "TOK_OP";
  	...
  	case TOK_OP_RANGE:	      	return "TOK_RANGE";
  	case TOK_OP_HASTYPE:	    	return "TOK_HASTYPE";
  	case TOK_OP_L_ARROW:	    	return "TOK_L_ARROW";
  	case TOK_OP_R_ARROW:	    	return "TOK_R_ARROW";
    case TOK_OP_R_FAT_ARROW:		return "TOK_R_FAT_ARROW";
		case '(':		            return "(";
		case ')':		            return ")";
		case ',':		            return ",";
		case ';':		            return ";";
